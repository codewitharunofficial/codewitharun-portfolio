      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        {qualifications.map((qual, index) => (
          <a
            href={qual.link}
            key={index}
            className="bg-gray-800 hover:bg-gray-700 text-white p-6 rounded-lg shadow-md cursor-pointer transition-transform transform hover:scale-105 flex flex-col gap-2"
            target="_blank"
          >
